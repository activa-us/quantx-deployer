...
"""
================================================================================
Strategy     : OPT_SPY_SHORT_PUT_SPREAD_7DTE
Underlying   : SPY.US
Strategy Type: SHORT_PUT_SPREAD
Strike Method: DELTA
DTE Target   : 7 days
...
# -- Configuration -----------------------------------------------------------
STRATEGY_NAME   = 'OPT_SPY_SHORT_PUT_SPREAD_7DTE'
EMAIL           = 'test@test.com'
CENTRAL_API_URL = ''
...
UNDERLYING      = 'SPY.US'          # e.g. 'SPY.US'
STRATEGY_TYPE   = 'SHORT_PUT_SPREAD'       # SHORT_PUT_SPREAD | IRON_CONDOR | etc.
STRIKE_METHOD   = 'DELTA'       # DELTA | POINTS_OTM | PCT_OTM | WING_POINTS
TARGET_DTE      = 7            # e.g. 7
DTE_TOLERANCE   = 2         # e.g. 2

# Strike values
PUT_DELTA       = -0.3             # e.g. -0.30
CALL_DELTA      = 0.3            # e.g.  0.30
PUT_WING_WIDTH  = 5.0        # points wide e.g. 5.0
CALL_WING_WIDTH = 5.0       # points wide e.g. 5.0
CUSTOM_LEGS     = []           # list of leg dicts for CUSTOM strategy

# Entry/Exit
ENTRY_TIME_ET   = '09:45'       # 'HH:MM' e.g. '09:45'
EXIT_TIME_ET    = '15:45'        # 'HH:MM' e.g. '15:45'
ENTRY_DAYS      = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri']            # e.g. ['Mon','Tue','Wed','Thu','Fri']

# Risk management
PROFIT_TARGET_PCT  = 0.5  # e.g. 0.50 = close at 50% max profit
STOP_LOSS_MULT     = 2.0     # e.g. 2.0 = close when loss = 2x credit
CONTRACTS          = 1          # number of spreads
MAX_DAILY_LOSS     = 5000.0     # dollar amount to halt trading
DRY_RUN            = True            # True = paper-trade only (uses live data, no real orders)
...
# Paths
LOG_DIR    = 'C:/Users/User/OneDrive/Desktop/quantx-deployer/quantx-deployer/logs'
TRADES_DIR = 'C:/Users/User/OneDrive/Desktop/quantx-deployer/quantx-deployer/trades'
STATE_DIR  = 'C:/Users/User/OneDrive/Desktop/quantx-deployer/quantx-deployer/state'
